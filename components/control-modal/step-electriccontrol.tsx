...
export function StepElectricControl({
  imageUris,
  description,
  needed,
  onChangeImages,
  ...
  return (
    <View style={styles.stepBody}>
      ...
      {needed ? (
        <>
          <View style={styles.fieldGroup}>
            <Text style={styles.fieldLabel}>
              Electric Control Images{imageUris.length > 0 ? `  ·  ${imageUris.length}` : ''}
            </Text>
        ...
        <Text style={styles.emptyHint}>Electric control is not needed for this element.</Text>
      )}
    </View>
  );
}
